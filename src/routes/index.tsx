...
// Только те виды спорта, которые реально доступны на наших партнёрских стадионах.
// По состоянию на контракт с «Луч» (СК на Волоколамке) у нас 4 направления.
// Когда подключим новые стадионы — расширим список.
const POPULAR_SPORTS = [
  { name: "Футбол", emoji: "⚽" },
  { name: "Мини-футбол", emoji: "⚽" },
  { name: "Волейбол", emoji: "🏐" },
  { name: "Теннис", emoji: "🎾" },
];
