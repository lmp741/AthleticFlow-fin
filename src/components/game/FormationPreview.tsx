...
const FORMATIONS_A: Record<number, SlotPreview[]> = {
  ...
  // 6×6 → 1-2-1-2 (фланг.ПЗ ближе к ЦПЗ, как на тренерской доске)
  6: [
    { x: 0.04, y: 0.5, role: "GK" },
    { x: 0.13, y: 0.32, role: "DF" },
    { x: 0.13, y: 0.68, role: "DF" },
    { x: 0.23, y: 0.5, role: "CM" },
    { x: 0.31, y: 0.3, role: "MF" },
    { x: 0.31, y: 0.7, role: "MF" },
  ],
  // 7×7 → 1-2-1-2-1 (ЦПЗ и фланг.ПЗ сдвинуты к защ, нап у круга)
  7: [
    { x: 0.04, y: 0.5, role: "GK" },
    { x: 0.12, y: 0.32, role: "DF" },
    { x: 0.12, y: 0.68, role: "DF" },
    { x: 0.20, y: 0.5, role: "CM" },
    { x: 0.28, y: 0.3, role: "MF" },
    { x: 0.28, y: 0.7, role: "MF" },
  ...
  // 11×11 → 1-4-4-2 (y-крайних ближе к центру, ПЗ сдвинуты вперёд, нап у круга)
  11: [
    { x: 0.03, y: 0.5, role: "GK" },
    { x: 0.13, y: 0.18, role: "LB" },
    { x: 0.13, y: 0.40, role: "CB" },
    { x: 0.13, y: 0.60, role: "CB" },
    { x: 0.13, y: 0.82, role: "RB" },
    { x: 0.27, y: 0.18, role: "LM" },
    { x: 0.27, y: 0.40, role: "CM" },
    { x: 0.27, y: 0.60, role: "CM" },
    { x: 0.27, y: 0.82, role: "RM" },
    { x: 0.42, y: 0.40, role: "ST" },
    { x: 0.42, y: 0.60, role: "ST" },
  ],
};
