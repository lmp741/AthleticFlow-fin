-- Чиним расстановку: нападающие были слишком близко к центру (x≈0.5),
-- перекрывали друг друга и стояли в центральном круге.
-- Новая раскладка: команда A в x ≤ 0.42, команда B в x ≥ 0.58.
-- Центр поля (0.45–0.55) — пустая нейтральная зона.
